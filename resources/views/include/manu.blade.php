...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      @if(Auth::user()->designation ==1)
        <li class="menu-item">
          <a href="" class="menu-link menu-toggle">
            ...
            <div data-i18n="Account Settings">Company</div>
          </a>
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="{{route('company.create')}}" class="menu-link">
                <div data-i18n="Account">Create Company</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('company.show')}}" class="menu-link">
                <div data-i18n="Notifications">Show Company</div>
              </a>
            </li>
          </ul>
        </li>
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="{{route('department.create')}}" class="menu-link">
                <div data-i18n="Basic">Create Department</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('department.show')}}" class="menu-link">
                <div data-i18n="Basic">Show Department</div>
              </a>
            </li>
          </ul>
        </li>
      ...
      @if(Auth::user()->designation ==1)
        <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
            <div data-i18n="Authentications">Designation</div>
          </a>
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="{{route('designation.create')}}" class="menu-link">
                <div data-i18n="Basic">Create Designation</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('designation.show')}}" class="menu-link">
                <div data-i18n="Basic">Show Designation</div>
              </a>
            </li>
          </ul>
        </li>
      ...
      @if(Auth::user()->designation == 1)
        <li class="menu-item">
          ...
          <ul class="menu-sub">
            ...
            <li class="menu-item">
              <a href="{{route('role.show')}}" class="menu-link">
                <div data-i18n="Basic">Show Role</div>
              </a>
            </li>
          </ul>
        </li>
    ...
    @if(Auth::user()->designation == 1)
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{route('user.show')}}" class="menu-link">
              <div data-i18n="Without menu">Show Employee</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{route('user.create')}}" class="menu-link">
              <div data-i18n="Without navbar">Create Employee</div>
            </a>
          </li>
        </ul>
      </li>
    @endif
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-layout"></i>
          <div data-i18n="Layouts">Leave Application</div>
        </a>
  
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{route('Allapplication.show')}}" class="menu-link">
